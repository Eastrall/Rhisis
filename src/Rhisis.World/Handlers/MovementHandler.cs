...
namespace Rhisis.World.Handlers
{
    public static class MovementHandler
    {
        ...
        public static void OnMovement(WorldClient client, INetPacketStream packet)
        {
            ...
            // if (player is dead || player is flying) 
            //     return;
            ...
            else
            {
                ...
                client.Player.MovableComponent.SpeedFactor = onPlayerMovedPacket.SpeedFactor;
            ...
            WorldPacketFactory.SendMoverMoved(client.Player, onPlayerMovedPacket.BeginPosition, onPlayerMovedPacket.DestinationPosition, onPlayerMovedPacket.SpeedFactor, onPlayerMovedPacket.State, onPlayerMovedPacket.StateFlag, onPlayerMovedPacket.Motion, onPlayerMovedPacket.MotionEx, onPlayerMovedPacket.Loop, onPlayerMovedPacket.MotionOption, onPlayerMovedPacket.TickCount);
        }
