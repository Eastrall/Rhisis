...
namespace Rhisis.World.Systems.Inventory
{
    ...
    public class InventorySystemOld : ISystem
    {
        ...
        /// <summary>
        /// Creates a new <see cref="InventorySystemOld"/> instance.
        /// </summary>
        public InventorySystemOld()
        {
            this.Logger = DependencyContainer.Instance.Resolve<ILogger<InventorySystemOld>>();
