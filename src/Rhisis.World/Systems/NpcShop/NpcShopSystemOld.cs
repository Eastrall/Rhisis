...
namespace Rhisis.World.Systems.NpcShop
{
    ...
    public class NpcShopSystemOld : ISystem
    {
        private readonly ILogger<NpcShopSystemOld> _logger;
        private readonly IGameResources _gameResources;
        private readonly INpcShopPacketFactory _npcShopPacketFactory;

        public NpcShopSystemOld(ILogger<NpcShopSystemOld> logger, IGameResources gameResources, INpcShopPacketFactory npcShopPacketFactory)
        {
            this._logger = logger;
